...
const NODES = [
  ...
  { id:'anthropic', x:1040,y:50,  label:'Claude',           icon:'🟣', cat:'ai',
    ...
    files:['frontend/src/lib/aiClient.js'] },
  { id:'n8n',       x:1240,y:50,  label:'N8N',              icon:'🟧', cat:'external',
    tech:'N8N — Webhook Node HTTP POST/GET',
    desc:'Automatización. AVI dispara webhooks N8N desde flujos o Herramientas IA. N8N puede llamar de vuelta a AVI via API keys.',
    files:['frontend/src/components/n8n/N8NIntegrationsPanel.jsx','backend/controllers/n8nIntegrations.controller.js'] },
  ...
  { id:'superadmin',x:590, y:248, label:'Super Admin',      icon:'👑', cat:'frontend',
    ...
    desc:'Gestiona cuentas, usuarios, config global, keys IA de plataforma, pricing, generador de prompts, soporte, N8N global, tutoriales y documentación.',
  ...
  { id:'mysql',     x:560, y:876, label:'MySQL 8',          icon:'🗄', cat:'database',
    ...
    desc:'Tablas: accounts, agents (prompts/channels/rag JSON), conversations (local_vars JSON), messages, flows (nodes JSON), variables, ai_tools, media (base64 LONGTEXT), n8n_integrations, api_keys, tutorials. Migraciones automáticas al arrancar.',
...
const EDGES = [
  ...
  {from:'n8n',to:'express',dashed:true},
