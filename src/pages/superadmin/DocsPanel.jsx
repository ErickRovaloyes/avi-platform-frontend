...
const NODES = [
  ...
  { id:'aiclient',  x:1240,y:460, label:'AI Client',        icon:'🤖', cat:'core',
    ...
    desc:'Cliente unificado para OpenAI y DeepSeek. El nodo Agente IA encadena hasta 10 rondas de herramientas, re-alimentando cada resultado.',
...
const EDGES = [
  ...
  {from:'openai',to:'aiclient'},{from:'deepseek',to:'aiclient'},
  ...
  return (
    <div className={s.root}>
      <div className={s.header}>
        <div>
          <h2 className={s.title}>Documentacion AVI Asistente</h2>
